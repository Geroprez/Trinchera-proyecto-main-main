...
public class MovimientoJugador : MonoBehaviour
{
    ...
    void Update()
    {
        if (!puedeMoverse) return;  // Si no puede moverse, salimos del Update.
    ...
    // Corutina para deshabilitar el movimiento durante un tiempo
    ...
    // Método para deshabilitar el movimiento cuando se activa el final
    public void DeshabilitarMovimientoFinal()
{
    puedeMoverse = false; // Deshabilitar el movimiento del jugador
    animator.SetBool("moviendo", false); // Detener animación de movimiento
    animator.SetBool("corriendo", false); // Detener animación de correr
    // Asegúrate de que también detenga otras animaciones de movimiento
}
